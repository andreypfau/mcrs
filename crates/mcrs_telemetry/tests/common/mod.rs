    ...
    S: tracing::Subscriber + for<'a> LookupSpan<'a>,
{
    fn on_new_span(
        ...
        self.buffer.lock().unwrap().push(CapturedSpan {
...
pub fn install_global_capture() -> Arc<Mutex<Vec<CapturedSpan>>> {
    ...
    SUBSCRIBER_INSTALLED.get_or_init(|| {
        ...
        // against the new subscriber. Without this, callsites that were evaluated
        // before the subscriber was installed remain permanently disabled.
