...
use mcrs_minecraft_inventory::{CurrentMenu, Menu, MenuLayout, MenuViewer, RemoteSlots, player_menu_layout};
...
pub fn open_menus(world: &mut World) {
    ...
    for player in joined {
        ...
        let selected = world.get::<SelectedHotbarSlot>(player).map_or(0, |selected| selected.0);
