...
//!
//! Required CI command:
//!   cargo test -p mcrs_minecraft_server --features=telemetry-tracy \
...
fn instrument_naming_convention_lighting() {
    ...
    // ── network site (exercised in mcrs_minecraft_server network integration tests) ─
    // span name: "network::process_received_packet"

    // ── world sites (exercised in mcrs_minecraft_server worldgen integration tests) ─
