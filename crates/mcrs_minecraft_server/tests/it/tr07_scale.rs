...
//!
//!     TR07_DURATION_SECS=300 cargo test -p mcrs_minecraft_server tr07 -- --ignored
//!
...
/// is opt-in. Run with:
///   TR07_DURATION_SECS=300 cargo test -p mcrs_minecraft_server tr07_profile_a_vanilla_long -- --ignored
#[test]
#[ignore]
