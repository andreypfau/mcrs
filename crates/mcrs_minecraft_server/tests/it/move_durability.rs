...
//! covered as an integration test in mcrs_minecraft_server (`confirmed_move_roundtrip`);
//! here we pin the engine mechanism the rollback depends on.

use bevy_ecs::entity::Entity;
use mcrs_minecraft_level::session::PlayerSession;
use mcrs_minecraft_level::world::in_flight::{InFlightEntry, InFlightMoves, alloc_move_id};
