...
impl<W: WorldGenVolume> Room<'_, '_, W> {
    ...
    fn default_floor(&mut self, xo: i32, zo: i32, down_opening: bool) {
        ...
        if down_opening {
            self.c.solid(&gray, [xo, 0, zo], [xo + 2, 0, zo + 7]);
            self.c.solid(&gray, [xo + 5, 0, zo], [xo + 7, 0, zo + 7]);
            self.c.solid(&gray, [xo + 3, 0, zo], [xo + 4, 0, zo + 2]);
            self.c
                .solid(&gray, [xo + 3, 0, zo + 5], [xo + 4, 0, zo + 7]);
            self.c
                .solid(&light, [xo + 3, 0, zo + 2], [xo + 4, 0, zo + 2]);
            self.c
                .solid(&light, [xo + 3, 0, zo + 5], [xo + 4, 0, zo + 5]);
            self.c
                .solid(&light, [xo + 2, 0, zo + 3], [xo + 2, 0, zo + 4]);
            self.c
                .solid(&light, [xo + 5, 0, zo + 3], [xo + 5, 0, zo + 4]);
        } else {
            self.c.solid(&gray, [xo, 0, zo], [xo + 7, 0, zo + 7]);
        }
    }
...
fn building<W: WorldGenVolume>(r: &mut Room<'_, '_, W>) {
    ...
    if r.chunk_intersects(22, 5, 35, 17) {
        ...
        for i in 0..4 {
            let z = 5 + i * 4;
            r.c.solid(&light, [24, 2, z], [24, 4, z]);
            r.c.solid(&light, [22, 4, z], [23, 4, z]);
            r.place(&light, 25, 5, z);
            r.place(&light, 26, 6, z);
            r.place(&lamp, 26, 5, z);
            r.c.solid(&light, [33, 2, z], [33, 4, z]);
            r.c.solid(&light, [34, 4, z], [35, 4, z]);
            r.place(&light, 32, 5, z);
            r.place(&light, 31, 6, z);
            r.place(&lamp, 31, 5, z);
            r.c.solid(&gray, [27, 6, z], [30, 6, z]);
        }
    }
    if r.chunk_intersects(15, 20, 42, 21) {
        r.c.solid(&gray, [15, 0, 21], [42, 0, 21]);
        r.water_box([26, 1, 21], [31, 3, 21]);
        r.c.solid(&gray, [21, 12, 21], [36, 12, 21]);
        r.c.solid(&gray, [17, 11, 21], [40, 11, 21]);
        r.c.solid(&gray, [16, 10, 21], [41, 10, 21]);
        r.c.solid(&gray, [15, 7, 21], [42, 9, 21]);
        r.c.solid(&gray, [16, 6, 21], [41, 6, 21]);
        r.c.solid(&gray, [17, 5, 21], [40, 5, 21]);
        r.c.solid(&gray, [21, 4, 21], [36, 4, 21]);
        r.c.solid(&gray, [22, 3, 21], [26, 3, 21]);
        r.c.solid(&gray, [31, 3, 21], [35, 3, 21]);
        r.c.solid(&gray, [23, 2, 21], [25, 2, 21]);
        r.c.solid(&gray, [32, 2, 21], [34, 2, 21]);
        r.c.solid(&light, [28, 4, 20], [29, 4, 21]);
    ...
    if r.chunk_intersects(21, 21, 36, 36) {
        r.c.solid(&gray, [21, 0, 22], [36, 0, 36]);
        r.water_box([21, 1, 22], [36, 23, 36]);
        for i in 0..4 {
            r.c.solid(&light, [21 + i, 13 + i, 21 + i], [36 - i, 13 + i, 21 + i]);
            r.c.solid(&light, [21 + i, 13 + i, 36 - i], [36 - i, 13 + i, 36 - i]);
            r.c.solid(&light, [21 + i, 13 + i, 22 + i], [21 + i, 13 + i, 35 - i]);
            r.c.solid(&light, [36 - i, 13 + i, 22 + i], [36 - i, 13 + i, 35 - i]);
        }
        r.c.solid(&gray, [25, 16, 25], [32, 16, 32]);
        r.c.solid(&light, [25, 17, 25], [25, 19, 25]);
        r.c.solid(&light, [32, 17, 25], [32, 19, 25]);
        r.c.solid(&light, [25, 17, 32], [25, 19, 32]);
        r.c.solid(&light, [32, 17, 32], [32, 19, 32]);
        ...
        r.c.solid(&gray, [28, 21, 27], [29, 21, 27]);
        r.c.solid(&gray, [27, 21, 28], [27, 21, 29]);
        r.c.solid(&gray, [28, 21, 30], [29, 21, 30]);
        r.c.solid(&gray, [30, 21, 28], [30, 21, 29]);
    }
    lower_wall(r);
    middle_wall(r);
    upper_wall(r);
...
fn wing<W: WorldGenVolume>(r: &mut Room<'_, '_, W>, flipped: bool, xoff: i32) {
    ...
    r.c.solid(&gray, [xoff, 0, 0], [xoff + 24, 0, 20]);
    r.water_box([xoff, 1, 0], [xoff + 24, 10, 20]);
    for i in 0..4 {
        r.c.solid(&light, [xoff + i, i + 1, i], [xoff + i, i + 1, 20]);
        r.c.solid(
            &light,
            [xoff + i + 7, i + 5, i + 7],
            [xoff + i + 7, i + 5, 20],
        ...
        r.c.solid(&light, [xoff + i + 1, i + 1, i], [xoff + 23 - i, i + 1, i]);
        r.c.solid(
            &light,
            [xoff + i + 8, i + 5, i + 7],
            [xoff + 16 - i, i + 5, i + 7],
    ...
    r.c.solid(&gray, [xoff + 4, 4, 4], [xoff + 6, 4, 20]);
    r.c.solid(&gray, [xoff + 7, 4, 4], [xoff + 17, 4, 6]);
    r.c.solid(&gray, [xoff + 18, 4, 4], [xoff + 20, 4, 20]);
    r.c.solid(&gray, [xoff + 11, 8, 11], [xoff + 13, 8, 20]);
    ...
    r.c.solid(&gray, [xoff + 11, 1, 12], [xoff + 13, 7, 12]);
    r.c.solid(&gray, [xoff + 12, 1, 11], [xoff + 12, 7, 13]);
}

fn lower_wall<W: WorldGenVolume>(r: &mut Room<'_, '_, W>) {
    let (gray, light) = (r.b.gray, r.b.light);
    if r.chunk_intersects(0, 21, 6, 58) {
        r.c.solid(&gray, [0, 0, 21], [6, 0, 57]);
        r.water_box([0, 1, 21], [6, 7, 57]);
        r.c.solid(&gray, [4, 4, 21], [6, 4, 53]);
        for i in 0..4 {
            r.c.solid(&light, [i, i + 1, 21], [i, i + 1, 57 - i]);
        }
        ...
        r.c.solid(&gray, [4, 1, 52], [6, 3, 52]);
        r.c.solid(&gray, [5, 1, 51], [5, 3, 53]);
    }
    if r.chunk_intersects(51, 21, 58, 58) {
        r.c.solid(&gray, [51, 0, 21], [57, 0, 57]);
        r.water_box([51, 1, 21], [57, 7, 57]);
        r.c.solid(&gray, [51, 4, 21], [53, 4, 53]);
        for i in 0..4 {
            r.c.solid(&light, [57 - i, i + 1, 21], [57 - i, i + 1, 57 - i]);
        }
        for z in (23..53).step_by(3) {
            r.place(&light, 52, 5, z);
        }
        r.place(&light, 52, 5, 52);
        r.c.solid(&gray, [51, 1, 52], [53, 3, 52]);
        r.c.solid(&gray, [52, 1, 51], [52, 3, 53]);
    }
    if r.chunk_intersects(0, 51, 57, 57) {
        r.c.solid(&gray, [7, 0, 51], [50, 0, 57]);
        r.water_box([7, 1, 51], [50, 10, 57]);
        for i in 0..4 {
            r.c.solid(&light, [i + 1, i + 1, 57 - i], [56 - i, i + 1, 57 - i]);
        }
    }
}
...
fn middle_wall<W: WorldGenVolume>(r: &mut Room<'_, '_, W>) {
    ...
    if r.chunk_intersects(7, 21, 13, 50) {
        r.c.solid(&gray, [7, 0, 21], [13, 0, 50]);
        r.water_box([7, 1, 21], [13, 10, 50]);
        r.c.solid(&gray, [11, 8, 21], [13, 8, 53]);
        for i in 0..4 {
            r.c.solid(&light, [i + 7, i + 5, 21], [i + 7, i + 5, 54]);
        }
    ...
    if r.chunk_intersects(44, 21, 50, 54) {
        r.c.solid(&gray, [44, 0, 21], [50, 0, 50]);
        r.water_box([44, 1, 21], [50, 10, 50]);
        r.c.solid(&gray, [44, 8, 21], [46, 8, 53]);
        for i in 0..4 {
            r.c.solid(&light, [50 - i, i + 5, 21], [50 - i, i + 5, 54]);
        }
        for z in (21..=45).step_by(3) {
    ...
    if r.chunk_intersects(8, 44, 49, 54) {
        r.c.solid(&gray, [14, 0, 44], [43, 0, 50]);
        ...
        for i in 0..3 {
            r.c.solid(&gray, [8 + i, 5 + i, 54], [49 - i, 5 + i, 54]);
        }
        r.c.solid(&light, [11, 8, 54], [46, 8, 54]);
        r.c.solid(&gray, [14, 8, 44], [43, 8, 53]);
    }
}
...
fn upper_wall<W: WorldGenVolume>(r: &mut Room<'_, '_, W>) {
    ...
    if r.chunk_intersects(14, 21, 20, 43) {
        r.c.solid(&gray, [14, 0, 21], [20, 0, 43]);
        r.water_box([14, 1, 22], [20, 14, 43]);
        r.c.solid(&gray, [18, 12, 22], [20, 12, 39]);
        r.c.solid(&light, [18, 12, 21], [20, 12, 21]);
        for i in 0..4 {
            r.c.solid(&light, [i + 14, i + 9, 21], [i + 14, i + 9, 43 - i]);
        }
    ...
    if r.chunk_intersects(37, 21, 43, 43) {
        r.c.solid(&gray, [37, 0, 21], [43, 0, 43]);
        r.water_box([37, 1, 22], [43, 14, 43]);
        r.c.solid(&gray, [37, 12, 22], [39, 12, 39]);
        r.c.solid(&light, [37, 12, 21], [39, 12, 21]);
        for i in 0..4 {
            r.c.solid(&light, [43 - i, i + 9, 21], [43 - i, i + 9, 43 - i]);
        }
        for z in (23..=39).step_by(3) {
    ...
    if r.chunk_intersects(15, 37, 42, 43) {
        r.c.solid(&gray, [21, 0, 37], [36, 0, 43]);
        r.water_box([21, 1, 37], [36, 14, 43]);
        r.c.solid(&gray, [21, 12, 37], [36, 12, 39]);
        for i in 0..4 {
            r.c.solid(&light, [15 + i, i + 9, 43 - i], [42 - i, i + 9, 43 - i]);
        }
...
fn core_room<W: WorldGenVolume>(r: &mut Room<'_, '_, W>) {
    ...
    r.c.solid(&light, [0, 7, 0], [0, 7, 15]);
    r.c.solid(&light, [15, 7, 0], [15, 7, 15]);
    r.c.solid(&light, [1, 7, 0], [15, 7, 0]);
    r.c.solid(&light, [1, 7, 15], [14, 7, 15]);
    for y in 1..=6 {
        let block = if y == 2 || y == 6 { gray } else { light };
        for x in (0..=15).step_by(15) {
            r.c.solid(&block, [x, y, 0], [x, y, 1]);
            r.c.solid(&block, [x, y, 6], [x, y, 9]);
            r.c.solid(&block, [x, y, 14], [x, y, 15]);
        }
        r.c.solid(&block, [1, y, 0], [1, y, 0]);
        r.c.solid(&block, [6, y, 0], [9, y, 0]);
        r.c.solid(&block, [14, y, 0], [14, y, 0]);
        r.c.solid(&block, [1, y, 15], [14, y, 15]);
    }
    r.c.solid(&black, [6, 3, 6], [9, 6, 9]);
    r.c.solid(&gold, [7, 4, 7], [8, 5, 8]);
...
fn double_x_room<W: WorldGenVolume>(r: &mut Room<'_, '_, W>, west: u8) {
    ...
    r.c.solid(&light, [0, 3, 0], [0, 3, 7]);
    r.c.solid(&light, [15, 3, 0], [15, 3, 7]);
    r.c.solid(&light, [1, 3, 0], [15, 3, 0]);
    r.c.solid(&light, [1, 3, 7], [14, 3, 7]);
    r.c.solid(&gray, [0, 2, 0], [0, 2, 7]);
    r.c.solid(&gray, [15, 2, 0], [15, 2, 7]);
    r.c.solid(&gray, [1, 2, 0], [15, 2, 0]);
    r.c.solid(&gray, [1, 2, 7], [14, 2, 7]);
    r.c.solid(&light, [0, 1, 0], [0, 1, 7]);
    r.c.solid(&light, [15, 1, 0], [15, 1, 7]);
    r.c.solid(&light, [1, 1, 0], [15, 1, 0]);
    r.c.solid(&light, [1, 1, 7], [14, 1, 7]);
    r.c.solid(&light, [5, 1, 0], [10, 1, 4]);
    r.c.solid(&gray, [6, 2, 0], [9, 2, 3]);
    r.c.solid(&light, [5, 3, 0], [10, 3, 4]);
    r.place(&lamp, 6, 2, 3);
    r.place(&lamp, 9, 2, 3);
...
fn double_xy_room<W: WorldGenVolume>(r: &mut Room<'_, '_, W>, west: u8) {
    ...
    for y in 1..=7 {
        let block = if y == 2 || y == 6 { gray } else { light };
        r.c.solid(&block, [0, y, 0], [0, y, 7]);
        r.c.solid(&block, [15, y, 0], [15, y, 7]);
        r.c.solid(&block, [1, y, 0], [15, y, 0]);
        r.c.solid(&block, [1, y, 7], [14, y, 7]);
    }
    for (min, max) in [
        ([2, 1, 3], [2, 7, 4]),
        ([3, 1, 2], [4, 7, 2]),
    ...
    r.place(&light, 6, 6, 5);
    r.place(&light, 9, 6, 5);
    r.c.solid(&light, [5, 4, 3], [6, 4, 4]);
    r.c.solid(&light, [9, 4, 3], [10, 4, 4]);
    r.place(&lamp, 5, 4, 2);
    r.place(&lamp, 5, 4, 5);
    r.place(&lamp, 10, 4, 2);
    r.place(&lamp, 10, 4, 5);
...
fn double_y_room<W: WorldGenVolume>(r: &mut Room<'_, '_, W>, room: u8) {
    ...
    for y in (1..=5).step_by(4) {
        if r.open(definition, SOUTH) {
            r.c.solid(&light, [2, y, 0], [2, y + 2, 0]);
            r.c.solid(&light, [5, y, 0], [5, y + 2, 0]);
            r.c.solid(&light, [3, y + 2, 0], [4, y + 2, 0]);
        } else {
            r.c.solid(&light, [0, y, 0], [7, y + 2, 0]);
            r.c.solid(&gray, [0, y + 1, 0], [7, y + 1, 0]);
        }
        if r.open(definition, NORTH) {
            r.c.solid(&light, [2, y, 7], [2, y + 2, 7]);
            r.c.solid(&light, [5, y, 7], [5, y + 2, 7]);
            r.c.solid(&light, [3, y + 2, 7], [4, y + 2, 7]);
        } else {
            r.c.solid(&light, [0, y, 7], [7, y + 2, 7]);
            r.c.solid(&gray, [0, y + 1, 7], [7, y + 1, 7]);
        }
        if r.open(definition, WEST) {
            r.c.solid(&light, [0, y, 2], [0, y + 2, 2]);
            r.c.solid(&light, [0, y, 5], [0, y + 2, 5]);
            r.c.solid(&light, [0, y + 2, 3], [0, y + 2, 4]);
        } else {
            r.c.solid(&light, [0, y, 0], [0, y + 2, 7]);
            r.c.solid(&gray, [0, y + 1, 0], [0, y + 1, 7]);
        }
        if r.open(definition, EAST) {
            r.c.solid(&light, [7, y, 2], [7, y + 2, 2]);
            r.c.solid(&light, [7, y, 5], [7, y + 2, 5]);
            r.c.solid(&light, [7, y + 2, 3], [7, y + 2, 4]);
        } else {
            r.c.solid(&light, [7, y, 0], [7, y + 2, 7]);
            r.c.solid(&gray, [7, y + 1, 0], [7, y + 1, 7]);
        }
        definition = above;
    }
}
...
fn double_yz_room<W: WorldGenVolume>(r: &mut Room<'_, '_, W>, south: u8) {
    ...
    for y in 1..=7 {
        let block = if y == 2 || y == 6 { gray } else { light };
        r.c.solid(&block, [0, y, 0], [0, y, 15]);
        r.c.solid(&block, [7, y, 0], [7, y, 15]);
        r.c.solid(&block, [1, y, 0], [6, y, 0]);
        r.c.solid(&block, [1, y, 15], [6, y, 15]);
    }
    for y in 1..=7 {
        let block = if y == 2 || y == 6 { lamp } else { black };
        r.c.solid(&block, [3, y, 7], [4, y, 8]);
    }
    ...
    if r.open(south_up, EAST) {
        ...
        r.c.solid(&light, [5, 4, 2], [6, 4, 5]);
        r.c.solid(&light, [6, 1, 2], [6, 3, 2]);
        r.c.solid(&light, [6, 1, 5], [6, 3, 5]);
    }
    if r.open(south_up, WEST) {
        r.water_box([0, 5, 3], [0, 6, 4]);
        r.c.solid(&light, [1, 4, 2], [2, 4, 5]);
        r.c.solid(&light, [1, 1, 2], [1, 3, 2]);
        r.c.solid(&light, [1, 1, 5], [1, 3, 5]);
    }
    ...
    if r.open(north_up, WEST) {
        ...
        r.c.solid(&light, [1, 4, 10], [2, 4, 13]);
        r.c.solid(&light, [1, 1, 10], [1, 3, 10]);
        r.c.solid(&light, [1, 1, 13], [1, 3, 13]);
    }
    if r.open(north_up, EAST) {
        r.water_box([7, 5, 11], [7, 6, 12]);
        r.c.solid(&light, [5, 4, 10], [6, 4, 13]);
        r.c.solid(&light, [6, 1, 10], [6, 3, 10]);
        r.c.solid(&light, [6, 1, 13], [6, 3, 13]);
    }
}
...
fn double_z_room<W: WorldGenVolume>(r: &mut Room<'_, '_, W>, south: u8) {
    ...
    r.c.solid(&light, [0, 3, 0], [0, 3, 15]);
    r.c.solid(&light, [7, 3, 0], [7, 3, 15]);
    r.c.solid(&light, [1, 3, 0], [7, 3, 0]);
    r.c.solid(&light, [1, 3, 15], [6, 3, 15]);
    r.c.solid(&gray, [0, 2, 0], [0, 2, 15]);
    r.c.solid(&gray, [7, 2, 0], [7, 2, 15]);
    r.c.solid(&gray, [1, 2, 0], [7, 2, 0]);
    r.c.solid(&gray, [1, 2, 15], [6, 2, 15]);
    for (min, max) in [
        ([0, 1, 0], [0, 1, 15]),
        ([7, 1, 0], [7, 1, 15]),
        ([1, 1, 0], [7, 1, 0]),
...
fn penthouse<W: WorldGenVolume>(r: &mut Room<'_, '_, W>, rng: &mut WorldgenRandom) {
    let (gray, light, black, lamp) = (r.b.gray, r.b.light, r.b.black, r.b.lamp);
    r.c.solid(&light, [2, -1, 2], [11, -1, 11]);
    r.c.solid(&gray, [0, -1, 0], [1, -1, 11]);
    r.c.solid(&gray, [12, -1, 0], [13, -1, 11]);
    r.c.solid(&gray, [2, -1, 0], [11, -1, 1]);
    r.c.solid(&gray, [2, -1, 12], [11, -1, 13]);
    r.c.solid(&light, [0, 0, 0], [0, 0, 13]);
    r.c.solid(&light, [13, 0, 0], [13, 0, 13]);
    r.c.solid(&light, [1, 0, 0], [12, 0, 0]);
    r.c.solid(&light, [1, 0, 13], [12, 0, 13]);
    for i in (2..=11).step_by(3) {
        r.place(&lamp, 0, 0, i);
        r.place(&lamp, 13, 0, i);
        r.place(&lamp, i, 0, 0);
    }
    r.c.solid(&light, [2, 0, 3], [4, 0, 9]);
    r.c.solid(&light, [9, 0, 3], [11, 0, 9]);
    r.c.solid(&light, [4, 0, 9], [9, 0, 11]);
    r.place(&light, 5, 0, 8);
    r.place(&light, 8, 0, 8);
    r.place(&light, 10, 0, 10);
    r.place(&light, 3, 0, 10);
    r.c.solid(&black, [3, 0, 3], [3, 0, 7]);
    r.c.solid(&black, [10, 0, 3], [10, 0, 7]);
    r.c.solid(&black, [6, 0, 10], [7, 0, 10]);
    for x in [3, 10] {
        for z in (2..=8).step_by(3) {
            r.c.solid(&light, [x, 0, z], [x, 2, z]);
        }
    }
    r.c.solid(&light, [5, 0, 10], [5, 2, 10]);
    r.c.solid(&light, [8, 0, 10], [8, 2, 10]);
    r.c.solid(&black, [6, -1, 7], [7, -1, 8]);
...
fn simple_room<W: WorldGenVolume>(
    ...
    let centre_pillar = main_design != 0
        ...
        && openings > 1;
    if main_design == 0 {
        r.c.solid(&light, [0, 1, 0], [2, 1, 2]);
        r.c.solid(&light, [0, 3, 0], [2, 3, 2]);
        r.c.solid(&gray, [0, 2, 0], [0, 2, 2]);
        r.c.solid(&gray, [1, 2, 0], [2, 2, 0]);
        r.place(&lamp, 1, 2, 1);
        r.c.solid(&light, [5, 1, 0], [7, 1, 2]);
        r.c.solid(&light, [5, 3, 0], [7, 3, 2]);
        r.c.solid(&gray, [7, 2, 0], [7, 2, 2]);
        r.c.solid(&gray, [5, 2, 0], [6, 2, 0]);
        r.place(&lamp, 6, 2, 1);
        r.c.solid(&light, [0, 1, 5], [2, 1, 7]);
        r.c.solid(&light, [0, 3, 5], [2, 3, 7]);
        r.c.solid(&gray, [0, 2, 5], [0, 2, 7]);
        r.c.solid(&gray, [1, 2, 7], [2, 2, 7]);
        r.place(&lamp, 1, 2, 6);
        r.c.solid(&light, [5, 1, 5], [7, 1, 7]);
        r.c.solid(&light, [5, 3, 5], [7, 3, 7]);
        r.c.solid(&gray, [7, 2, 5], [7, 2, 7]);
        r.c.solid(&gray, [5, 2, 7], [6, 2, 7]);
        r.place(&lamp, 6, 2, 6);
        if r.open(room, SOUTH) {
            r.c.solid(&light, [3, 3, 0], [4, 3, 0]);
        } else {
            r.c.solid(&light, [3, 3, 0], [4, 3, 1]);
            r.c.solid(&gray, [3, 2, 0], [4, 2, 0]);
            r.c.solid(&light, [3, 1, 0], [4, 1, 1]);
        }
        if r.open(room, NORTH) {
            r.c.solid(&light, [3, 3, 7], [4, 3, 7]);
        } else {
            r.c.solid(&light, [3, 3, 6], [4, 3, 7]);
            r.c.solid(&gray, [3, 2, 7], [4, 2, 7]);
            r.c.solid(&light, [3, 1, 6], [4, 1, 7]);
        }
        if r.open(room, WEST) {
            r.c.solid(&light, [0, 3, 3], [0, 3, 4]);
        } else {
            r.c.solid(&light, [0, 3, 3], [1, 3, 4]);
            r.c.solid(&gray, [0, 2, 3], [0, 2, 4]);
            r.c.solid(&light, [0, 1, 3], [1, 1, 4]);
        }
        if r.open(room, EAST) {
            r.c.solid(&light, [7, 3, 3], [7, 3, 4]);
        } else {
            r.c.solid(&light, [6, 3, 3], [7, 3, 4]);
            r.c.solid(&gray, [7, 2, 3], [7, 2, 4]);
            r.c.solid(&light, [6, 1, 3], [7, 1, 4]);
        }
    } else if main_design == 1 {
        r.c.solid(&light, [2, 1, 2], [2, 3, 2]);
        r.c.solid(&light, [2, 1, 5], [2, 3, 5]);
        r.c.solid(&light, [5, 1, 5], [5, 3, 5]);
        r.c.solid(&light, [5, 1, 2], [5, 3, 2]);
        r.place(&lamp, 2, 2, 2);
        r.place(&lamp, 2, 2, 5);
        r.place(&lamp, 5, 2, 5);
        r.place(&lamp, 5, 2, 2);
        r.c.solid(&light, [0, 1, 0], [1, 3, 0]);
        r.c.solid(&light, [0, 1, 1], [0, 3, 1]);
        r.c.solid(&light, [0, 1, 7], [1, 3, 7]);
        r.c.solid(&light, [0, 1, 6], [0, 3, 6]);
        r.c.solid(&light, [6, 1, 7], [7, 3, 7]);
        r.c.solid(&light, [7, 1, 6], [7, 3, 6]);
        r.c.solid(&light, [6, 1, 0], [7, 3, 0]);
        r.c.solid(&light, [7, 1, 1], [7, 3, 1]);
        r.place(&gray, 1, 2, 0);
        r.place(&gray, 0, 2, 1);
        r.place(&gray, 1, 2, 7);
        r.place(&gray, 0, 2, 6);
        ...
        r.place(&gray, 7, 2, 1);
        if !r.open(room, SOUTH) {
            r.c.solid(&light, [1, 3, 0], [6, 3, 0]);
            r.c.solid(&gray, [1, 2, 0], [6, 2, 0]);
            r.c.solid(&light, [1, 1, 0], [6, 1, 0]);
        }
        if !r.open(room, NORTH) {
            r.c.solid(&light, [1, 3, 7], [6, 3, 7]);
            r.c.solid(&gray, [1, 2, 7], [6, 2, 7]);
            r.c.solid(&light, [1, 1, 7], [6, 1, 7]);
        }
        if !r.open(room, WEST) {
            r.c.solid(&light, [0, 3, 1], [0, 3, 6]);
            r.c.solid(&gray, [0, 2, 1], [0, 2, 6]);
            r.c.solid(&light, [0, 1, 1], [0, 1, 6]);
        }
        if !r.open(room, EAST) {
            r.c.solid(&light, [7, 3, 1], [7, 3, 6]);
            r.c.solid(&gray, [7, 2, 1], [7, 2, 6]);
            r.c.solid(&light, [7, 1, 1], [7, 1, 6]);
        }
    } else if main_design == 2 {
        r.c.solid(&light, [0, 1, 0], [0, 1, 7]);
        r.c.solid(&light, [7, 1, 0], [7, 1, 7]);
        r.c.solid(&light, [1, 1, 0], [6, 1, 0]);
        r.c.solid(&light, [1, 1, 7], [6, 1, 7]);
        r.c.solid(&black, [0, 2, 0], [0, 2, 7]);
        r.c.solid(&black, [7, 2, 0], [7, 2, 7]);
        r.c.solid(&black, [1, 2, 0], [6, 2, 0]);
        r.c.solid(&black, [1, 2, 7], [6, 2, 7]);
        r.c.solid(&light, [0, 3, 0], [0, 3, 7]);
        r.c.solid(&light, [7, 3, 0], [7, 3, 7]);
        r.c.solid(&light, [1, 3, 0], [6, 3, 0]);
        r.c.solid(&light, [1, 3, 7], [6, 3, 7]);
        r.c.solid(&black, [0, 1, 3], [0, 2, 4]);
        r.c.solid(&black, [7, 1, 3], [7, 2, 4]);
        r.c.solid(&black, [3, 1, 0], [4, 2, 0]);
        r.c.solid(&black, [3, 1, 7], [4, 2, 7]);
        if r.open(room, SOUTH) {
            r.water_box([3, 1, 0], [4, 2, 0]);
        }
        if r.open(room, NORTH) {
    ...
    if centre_pillar {
        r.c.solid(&light, [3, 1, 3], [4, 1, 4]);
        r.c.solid(&gray, [3, 2, 3], [4, 2, 4]);
        r.c.solid(&light, [3, 3, 3], [4, 3, 4]);
    }
}
    ...
    for x in 1..=6 {
        for z in 1..=6 {
            if rng.next_i32_bound(3) != 0 {
                ...
                r.c.solid(&wet_sponge, [x, y0, z], [x, 3, z]);
            }
        }
    }
    r.c.solid(&light, [0, 1, 0], [0, 1, 7]);
...
fn wing_room<W: WorldGenVolume>(
    ...
    if main_design == 0 {
        for i in 0..4 {
            r.c.solid(&light, [10 - i, 3 - i, 20 - i], [12 + i, 3 - i, 20]);
        }
        r.c.solid(&light, [7, 0, 6], [15, 0, 16]);
        r.c.solid(&light, [6, 0, 6], [6, 3, 20]);
        r.c.solid(&light, [16, 0, 6], [16, 3, 20]);
        r.c.solid(&light, [7, 1, 7], [7, 1, 20]);
        r.c.solid(&light, [15, 1, 7], [15, 1, 20]);
        r.c.solid(&light, [7, 1, 6], [9, 3, 6]);
        r.c.solid(&light, [13, 1, 6], [15, 3, 6]);
        r.c.solid(&light, [8, 1, 7], [9, 1, 7]);
        r.c.solid(&light, [13, 1, 7], [14, 1, 7]);
        r.c.solid(&light, [9, 0, 5], [13, 0, 5]);
        r.c.solid(&black, [10, 0, 7], [12, 0, 7]);
        r.c.solid(&black, [8, 0, 10], [8, 0, 12]);
        r.c.solid(&black, [14, 0, 10], [14, 0, 12]);
        ...
        r.c.solid(&light, [6, 0, 21], [7, 4, 21]);
        r.c.solid(&light, [15, 0, 21], [16, 4, 21]);
        r.spawn_elder(rng, 11, 2, 16);
    } else if main_design == 1 {
        r.c.solid(&light, [9, 3, 18], [13, 3, 20]);
        r.c.solid(&light, [9, 0, 18], [9, 2, 18]);
        r.c.solid(&light, [13, 0, 18], [13, 2, 18]);
        for x in [9, 13] {
            r.place(&light, x, 6, 20);
            r.place(&lamp, x, 5, 20);
            r.place(&light, x, 4, 20);
        }
        r.c.solid(&light, [7, 3, 7], [15, 3, 14]);
        for x in [10, 12] {
            r.c.solid(&light, [x, 0, 10], [x, 6, 10]);
            r.c.solid(&light, [x, 0, 12], [x, 6, 12]);
            r.place(&lamp, x, 0, 10);
            r.place(&lamp, x, 0, 12);
            r.place(&lamp, x, 4, 10);
            r.place(&lamp, x, 4, 12);
        ...
        for x in [8, 14] {
            r.c.solid(&light, [x, 0, 7], [x, 2, 7]);
            r.c.solid(&light, [x, 0, 14], [x, 2, 14]);
        }
        r.c.solid(&black, [8, 3, 8], [8, 3, 13]);
        r.c.solid(&black, [14, 3, 8], [14, 3, 13]);
