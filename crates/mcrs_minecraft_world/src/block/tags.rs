...
pub const MINEABLE_SHOVEL: TagKey<Block> =
    TagKey::new(mcrs_minecraft_core::rl!("minecraft:mineable/shovel"));
pub const MINEABLE_HOE: TagKey<Block> =
    TagKey::new(mcrs_minecraft_core::rl!("minecraft:mineable/hoe"));

// incorrect_for_* — used by ToolMaterial to deny drops
pub const INCORRECT_FOR_WOODEN_TOOL: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!(
    "minecraft:incorrect_for_wooden_tool"
));
pub const INCORRECT_FOR_STONE_TOOL: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!(
    "minecraft:incorrect_for_stone_tool"
));
pub const INCORRECT_FOR_COPPER_TOOL: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!(
    "minecraft:incorrect_for_copper_tool"
));
pub const INCORRECT_FOR_IRON_TOOL: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!(
    "minecraft:incorrect_for_iron_tool"
));
pub const INCORRECT_FOR_DIAMOND_TOOL: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!(
    "minecraft:incorrect_for_diamond_tool"
));
pub const INCORRECT_FOR_GOLD_TOOL: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!(
    "minecraft:incorrect_for_gold_tool"
));
pub const INCORRECT_FOR_NETHERITE_TOOL: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!(
...
pub const BLOCKS_WIND_CHARGE_EXPLOSIONS: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!(
