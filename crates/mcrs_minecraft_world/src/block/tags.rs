...
pub const MINEABLE_AXE: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!("minecraft:mineable/axe"));
pub const MINEABLE_SHOVEL: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!("minecraft:mineable/shovel"));
pub const MINEABLE_HOE: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!("minecraft:mineable/hoe"));

// incorrect_for_* — used by ToolMaterial to deny drops
pub const INCORRECT_FOR_WOODEN_TOOL: TagKey<Block> =
    TagKey::new(mcrs_minecraft_core::rl!("minecraft:incorrect_for_wooden_tool"));
pub const INCORRECT_FOR_STONE_TOOL: TagKey<Block> =
    TagKey::new(mcrs_minecraft_core::rl!("minecraft:incorrect_for_stone_tool"));
pub const INCORRECT_FOR_COPPER_TOOL: TagKey<Block> =
    TagKey::new(mcrs_minecraft_core::rl!("minecraft:incorrect_for_copper_tool"));
pub const INCORRECT_FOR_IRON_TOOL: TagKey<Block> =
    TagKey::new(mcrs_minecraft_core::rl!("minecraft:incorrect_for_iron_tool"));
pub const INCORRECT_FOR_DIAMOND_TOOL: TagKey<Block> =
    TagKey::new(mcrs_minecraft_core::rl!("minecraft:incorrect_for_diamond_tool"));
pub const INCORRECT_FOR_GOLD_TOOL: TagKey<Block> =
    TagKey::new(mcrs_minecraft_core::rl!("minecraft:incorrect_for_gold_tool"));
pub const INCORRECT_FOR_NETHERITE_TOOL: TagKey<Block> =
    TagKey::new(mcrs_minecraft_core::rl!("minecraft:incorrect_for_netherite_tool"));

// World logic — expand as features need them
pub const LOGS: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!("minecraft:logs"));
pub const LEAVES: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!("minecraft:leaves"));
...
pub const LIGHTNING_RODS: TagKey<Block> = TagKey::new(mcrs_minecraft_core::rl!("minecraft:lightning_rods"));
pub const SOUL_SPEED_BLOCKS: TagKey<Block> =
    TagKey::new(mcrs_minecraft_core::rl!("minecraft:soul_speed_blocks"));
pub const BLOCKS_WIND_CHARGE_EXPLOSIONS: TagKey<Block> =
    TagKey::new(mcrs_minecraft_core::rl!("minecraft:blocks_wind_charge_explosions"));
