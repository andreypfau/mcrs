//! Typed helpers around `mcrs_voxel_world::world::storage::column::Heightmaps` plus the
...
use mcrs_voxel_world::world::storage::column::{ColumnScalarKey, ColumnScalarRegistry, Heightmaps};
