...
impl Default for ToolRule {
    fn default() -> Self {
        Self {
            blocks: block_tags::MINEABLE_PICKAXE,
            speed: None,
...
impl ToolMaterial {
    ...
    pub const fn incorrect_blocks_for_drops(&self) -> TagKey<Block> {
    ...
    pub const fn for_mineable_blocks(&self, mineable: TagKey<Block>) -> [ToolRule; 2] {
        [
            ToolRule {
                blocks: self.incorrect_blocks_for_drops,
                speed: None,
                correct_for_drops: Some(false),
            },
