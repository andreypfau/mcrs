...
use crate::placer::{BlockLayout, Rule, StateMask, WorldGenVolume, WorldStates};
use crate::proto::{
    LinearPos, PosRuleTest, ProcessorRule, RuleBlockEntityModifier, StructureProcessor,
};
use crate::template::Projection;
use crate::template::{FrozenTemplate, JigsawBlock, transform};
use bevy_math::IVec3;
...
mod tests {
    ...
    use super::*;
    use crate::placer::{BoxRegion, PropertyLayout, mask_of};
    use crate::template::FrozenBlock;
    ...
    fn jigsaws_template() -> JigsawBlock {
        JigsawBlock {
            ...
            top: Direction::Up,
            joint: crate::template::Joint::Rollable,
