...
use crate::place::random_direction;
...
use crate::place::speleothem::{PointedStates, grow_speleothem};
...
mod tests {
    ...
    use super::*;
    use crate::place::speleothem::{FRUSTUM, TIP};
    ...
    fn config() -> CompiledSpeleothem {
        CompiledSpeleothem {
            base_block: BASE,
            pointed: crate::place::speleothem::tests::pointed_states(POINTED.0),
