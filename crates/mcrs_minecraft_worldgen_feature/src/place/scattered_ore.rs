...
use crate::place::ore_modern::{CompiledOre, can_place_ore};
...
/// and its air-exposure test with the vein of [`crate::place::ore_modern`];
...
mod tests {
    ...
    use super::*;
    use crate::place::ore_modern::OreReplacement;
    use crate::placer::{BoxRegion, Rule, single_state};
